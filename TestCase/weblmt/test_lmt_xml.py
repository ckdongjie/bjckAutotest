...
class TestWeblmtXml():   
    ...
    def testDownloadXmlAndUploadXmlOnWeblmt(self, testNum, xmlFileName='BntCfgFile', xmlSavePath=BASIC_DATA['version']['xmlSavePath'], cellId=0):
        with allure.step('weblmt配置文件导出导入压力测试'):
            weblmt = key_weblmt_login(BASIC_DATA['weblmt']['ip'])
            for i in range (1,testNum+1):
                logging.info(key_get_time()+':run the test <'+str(i)+'> times')
                with allure.step(key_get_time()+'执行第 '+str(i)+'次测试'):
                    #下载xml文件到本地
                    exportRes = key_export_xml_file(weblmt, xmlSavePath, xmlFileName)
    ...
    def testImportXmlSnIsNone(self, xmlFileName='BntCfgFile', xmlSavePath=BASIC_DATA['version']['xmlSavePath'], cellId=0):
    ...
    def testImportXmlSnIsShort(self, xmlFileName='BntCfgFile', xmlSavePath=BASIC_DATA['version']['xmlSavePath'], cellId=0):
    ...
    def testImportXmlSnIsLong(self, xmlFileName='BntCfgFile', xmlSavePath=BASIC_DATA['version']['xmlSavePath'], cellId=0):
    ...
    def testImportXmlSnIsAbnormal(self, xmlFileName='BntCfgFile', xmlSavePath=BASIC_DATA['version']['xmlSavePath'], cellId=0):
    ...
    def testImportXmlTacIsAbnormal(self, xmlFileName='BntCfgFile' ,xmlSavePath=BASIC_DATA['version']['xmlSavePath']):
