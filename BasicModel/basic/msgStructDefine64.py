...
class T_EICellULDetailState:
    def __init__(self):
        ...
        self.u64CellULPdcpThrput = 0
        self.u64CellULWifiThrput = 0 # add dj
        self.u8ULRbRatio = 0
    ...
    def pack(self):
        buffer = struct.pack('<2I2Q4B12HI', self.u32CellULMacThroughput, self.u32CellULRlcThrput, self.u64CellULPdcpThrput, self.u64CellULWifiThrput, self.u8ULRbRatio,
...
class T_EICellDLDetailState:
    def __init__(self):
        ...
        self.u64CellDLPdcpThrput = 0
        self.u64CellDLWifiThrput = 0  # add dj
        self.u8DLRbRatio = 0
    ...
    def pack(self):
        buffer = struct.pack('<2I2Q4B7H4B5H', self.u32CellDLMacThroughput, self.u32CellDLRlcThrput, self.u64CellDLPdcpThrput, self.u64CellDLWifiThrput, self.u8DLRbRatio,
...
class T_EIUEGeneralInfo:
    def __init__(self):
        ...
        self.u8IsUsed = 0
        self.u8PL = 0
        self.u64ULPdcpThrput = 0 #dj
        self.u32ULRlcThrput = 0
        self.u64DLPdcpThrput = 0  #dj
    ...
    def pack(self):
        buffer = struct.pack('<4BQIQIQ2I14H2B2H2BHh', self.u8UELiveCount, self.u8IsUsed, self.u8PL, 0, self.u64ULPdcpThrput, self.u32ULRlcThrput,
                             self.u64DLPdcpThrput, self.u32DLRlcThrput, self.u64IP, self.u32ULMacThrput, self.u32DLMacThrput, self.u16ULSchdCnt, self.u16DLSchdCnt,
